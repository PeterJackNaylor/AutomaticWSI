...
PROJECT_NAME=only_fab
PROJECT_VERSION=1-0
TIFF_LOCATION=../Data/Biopsy/
TISSUE_BOUNDARIES=../Data/Biopsy/tissue_segmentation
INNER_FOLD=5
NUMBER_OF_FOLDS=5
LABEL=/mnt/data3/pnaylor/AutomaticWSI/outputs/only_fab_label_${NUMBER_OF_FOLDS}.csv
