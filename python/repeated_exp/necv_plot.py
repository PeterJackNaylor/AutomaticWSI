...
colors = {"ncv": ("rgb(31,120,180)", "rgb(166, 206, 227)", "rgba(166, 206, 227,0.1)"),
          "bncv": ("rgb(51,160,44)", "rgba(51,160,44,0.1)", "rgba(178,223,138,0.1)"),
          "bncv_top_3": ("rgb(227,26,28)", "rgba(227,26,28,0.1)", "rgba(251,154,153,0.1)"),
          "bncv_top_5": ("rgb(255,127,0)", "rgba(255,127,0,0.1)", "rgba(253,191,111,0.1)"),
          "bayes": ("rgb(106,61,154)", "rgb(106,61,154)", "rgba(106,61,154,0.1)"),
          "bfcv": ("rgb(178,223,138)", "rgba(178,223,138,0.1)", "rgba(178,223,138,0.1)"),
          "bfcv_top_3": ("rgb(251,154,153)", "rgba(251,154,153,0.1)", "rgba(251,154,153,0.1)"),
          "bfcv_top_5": ("rgb(253,191,111)", "rgba(253,191,111,0.1)", "rgba(253,191,111,0.1)"),
          }
