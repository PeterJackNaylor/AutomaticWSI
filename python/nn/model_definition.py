...
def mlp_2_layer(n_classes, hidden_fcn=512, 
                       weight_decay=0.0005, input_depth=2048, drop_out=0.5, 
                       gaussian_param=0):
    """
    The simplest version of model_1.
    ...
    x_i = dense_bn_act_drop(x_i, hidden_fcn, "fcn_1_1", 
                            weight_decay, drop_out)
    x_i = dense_bn_act_drop(x_i, hidden_fcn, "fcn_1_2", 
                            weight_decay, drop_out)
...
def load_model_hardlabel(parameter_dic, options, verbose=True):
    """
    ...
    -------
    Object: keras.models.Model
        Compiled keras model for hardlabeling.
    ...
    model = mlp_2_layer(n_classes, hidden_fcn, weight_decay, input_depth,
                drop_out, gaussian_param)
